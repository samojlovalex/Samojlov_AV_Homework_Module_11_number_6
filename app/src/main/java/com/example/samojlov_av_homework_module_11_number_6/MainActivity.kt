...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var enterMainActivityBT: Button
...
//        setContentView(R.layout.activity_main)
    ...
    private fun init() {
        ...
        toolbarMain.setLogo(R.drawable.image_icon)

        enterMainActivityBT = binding.enterMainActivityBT
        enterMainActivityBT.setOnClickListener {
            val intent = Intent(this, ImageAlbumActivity::class.java)
